...
<ContentWrapper>
	<section class="mt-8 mb-10 px-4 text-center sm:mt-12 sm:mb-14">
		<div class="mx-auto max-w-3xl">
			...
			<p
				class="text-muted-foreground mx-auto mt-3 mb-6 max-w-2xl text-lg leading-relaxed font-light sm:mb-8 sm:text-xl"
			>
			...
			<div class="bg-card flex items-start gap-4 rounded-lg border p-4 sm:p-6">
				...
				<div>
					...
					<p class="text-muted-foreground text-xs sm:text-sm">
						Download or copy the generated <code class="bg-muted rounded px-1 py-0.5 text-[10px]"
	...
	<Alert.Root
		class="mx-auto mt-6 max-w-4xl border-blue-200 bg-blue-50/50 pb-5 sm:mt-8 dark:border-blue-800 dark:bg-blue-950/20"
	>
		<Lightbulb class="size-4 text-blue-600 dark:text-blue-400" />
