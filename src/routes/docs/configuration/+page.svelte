		...
		<Table.Root class="mb-8">
			...
			<Table.Body>
				...
				<Table.Row>
					...
					<Table.Cell
						><code class="bg-muted rounded px-1 py-0.5"
							>https://your-provider.com/oidc/authorize</code
						></Table.Cell
					>
				</Table.Row>
				<Table.Row>
					...
					<Table.Cell
						><code class="bg-muted rounded px-1 py-0.5">https://your-provider.com/oidc/token</code
						></Table.Cell
					>
				</Table.Row>
				<Table.Row>
					...
					<Table.Cell
						><code class="bg-muted rounded px-1 py-0.5"
							>https://your-provider.com/oidc/userinfo</code
						></Table.Cell
					>
				</Table.Row>
				<Table.Row>
